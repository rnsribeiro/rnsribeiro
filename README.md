...
Desenvolvedor Full Stack com atuação em arquitetura de sistemas, desenvolvimento de software, code review e deploy em homologação e produção. Minha trajetória reúne experiência com aplicações web, APIs, infraestrutura, automação, inteligência artificial aplicada, Internet das Coisas e sistemas embarcados.

Também tenho interesse contínuo em construir soluções práticas, com foco em desempenho, manutenção e evolução técnica constante.

## Atuação na área

- Desenvolvimento Full Stack para aplicações web e sistemas corporativos
- Arquitetura de sistemas e organização de soluções escaláveis
...
JavaScript, TypeScript, React, Vue, Next.js, Nuxt, HTML e CSS
...
SQL, NoSQL, Linux, Docker, virtualização e Bash/Shell
...
- Engenharia de Computação - UNIVESP, conclusão em dezembro de 2022
- Técnico em Informática - ETEC Prof. Nair Luccas Ribeiro, conclusão em junho de 2013
- Tecnologia da Informação / Sistemas da Informação - UNIPAR, formação incompleta entre 2009 e 2010
...
- Residência Tecnológica em Sistemas Embarcados com Aplicação em Internet das Coisas, EmbarcaTech / Softex, entre novembro de 2024 e fevereiro de 2025
- Curso de Robô e Indicador para o Mercado Financeiro - PROFIT, Udemy, concluído em 17 de março de 2024
- Introdução à Ciência da Computação com Python, Coursera / USP, concluído em 31 de janeiro de 2022
- Curso de Programação em Linguagem C para Iniciantes, UNESP, 60h, concluído em 10 de julho de 2015
...
<div align="center">
  <img src="https://raw.githubusercontent.com/rnsribeiro/rnsribeiro/output/github-contribution-grid-snake-dark.svg" alt="Animação das contribuições no GitHub" />
</div>
